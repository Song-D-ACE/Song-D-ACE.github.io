...
dataRange: {
    ...
    backgroundColor: 'rgba(0,0,0,0)', //临时选区背景
    borderColor: '#ccc', // 值域边框颜色
    borderWidth: 0, // 值域边框线宽，单位px，默认为0（无边框）
    padding: 1, // 值域内边距，单位px，默认各方向内边距为5，接受数组分别设定上右下左边距，同css
    ...
    splitNumber: 2, // 分割段数，默认为5，为0时为线性渐变
    color:['#ff0000','#00ffff'],//颜色 
    text:['高','低'], // 文本，默认为数值文本
    textStyle: {
        color: '#333' // 值域文字颜色
    }
...
toolbox: {
    ...
    y: 'top', // 垂直安放位置，默认为全图顶端，可选为：'top' ¦ 'bottom' ¦ 'center' ¦ {number}（y坐标，单位px）
    color : ['#ff0000','#00ff00','#0000ff','#ff00ff'], // 工具箱文字颜色
    ...
    featureTitle : {  //以下皆为 Boolean 值 true ¦ false
        mark : '辅助线开关',
        markUndo : '删除辅助线',
        markClear : '清空辅助线',
        dataZoom : '区域缩放',
...
dataZoom: {
    ...
    fillerColor: 'rgba(0, 0, 0, 0.2)', // 填充颜色
    handleColor: 'rgba(255, 0, 0, 0.8)' // 手柄颜色
}
`````
...
bar: {
    ...
    itemStyle: {
        ...
        label: {
            show: false,
            position:      // 默认自适应，水平布局为'top'，垂直布局为'right'，可选为 'inside'|'left'|'right'|'top'|'bottom'
    ...
    emphasis: {
        ...
        label: {
            show:{ // 可以是 false
                position: auto //水平布局为'top'，垂直布局为'right'，可选为'inside'|'left'|'right'|'top'|'bottom'
                textStyle: null // 默认使用全局文本样式，详见TEXTSTYLE
            }
        }
    }
    ...
    itemStyle: {
        normal: {
            ...
            emphasis: {
                ...
                label: {
                    show: false
                    position: null, // 水平布局为'top'，垂直布局为'right'，可选为 'inside'|'left'|'right'|'top'|'bottom'
                    textStyle: null // 默认使用全局文本样式，详见TEXTSTYLE
                }
            }
        },
...
scatter: {
    ...
    itemStyle: {
        ...
        label: {
            show: {  // true false
                position:  'auto'// 默认自适应，水平布局为'top'，垂直布局为'right'，可选为'inside'|'left'|'right'|'top'|'bottom'
                textStyle: null // 默认使用全局文本样式，详见TEXTSTYLE
            }
        }
    }
